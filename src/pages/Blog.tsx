          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {blogPosts.map((post, i) => (
              ...
              >
                <Link
                  to={`/blog/${post.slug}`}
                  className="group block rounded-[var(--radius-xl)] overflow-hidden bg-[var(--color-bg-surface)] border border-[var(--color-border)] hover:border-[var(--color-border-accent)] transition-all duration-300 hover:scale-[1.01]"
                >
                  ...
                  <div className="p-6">
                    ...
                    <span className="mt-4 inline-flex items-center gap-1 text-sm text-[var(--color-accent)] font-medium group-hover:gap-2 transition-all">
