  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="container-site relative z-10 text-center max-w-4xl mx-auto py-4"
      >
        {/* Urgency capsule */}
        ...
        <h2 
          className="font-display font-black text-4xl md:text-7xl uppercase leading-none text-white mb-8 tracking-tighter"
        >
          READY TO <span className="font-serif italic lowercase text-[var(--color-accent)] font-normal">fly</span>?
        </h2>
        
        <div className="max-w-3xl mx-auto mb-12 flex justify-center">
          <p className="text-base md:text-xl font-medium text-[var(--color-text-secondary)] leading-relaxed text-center max-w-2xl">
            Become the machine. Unlock your body's true potential at Delhi's premier gymnastics, calisthenics, and parkour academy.
          </p>
        </div>
